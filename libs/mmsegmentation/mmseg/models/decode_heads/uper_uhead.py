...
class UPer_UHead(BaseDecodeHead):
    ...
    def __init__(self, 
                ...
                upsample_cfg=dict(type='InterpConv'),
                **kwargs):
        super(UPer_UHead, self).__init__(
        ...
        self.feature_concate = ConvModule(
    ...
    def _forward_feature(self, inputs):
        ...
        feats_fused = torch.cat([feats, dec_outs[-1]], dim=1)
        feats_fused = self.feature_concate(feats_fused)
