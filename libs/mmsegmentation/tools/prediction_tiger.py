...
DATA_DIR_SAVE = "/media/mingfan/DATASSD/TIGER/mmsegmentation/weight/1024/Result"


DATA_DIR = "/media/mingfan/DataHDD/DATA_Tiger/wsirois/roi-level-annotations/tissue-bcss"
IMAGE_PATH = osp.join(DATA_DIR, "images") #images_patch
VAL_TXT_PATH = osp.join(DATA_DIR, "val_1_fold_1030.txt")
TRAIN_TXT_PATH = osp.join(DATA_DIR, "train_1_fold_1030.txt")
WEIGHT_DIR = "/media/mingfan/DATASSD/TIGER/mmsegmentation/weight/1024"

config_file = osp.join(WEIGHT_DIR, 'kent_tiger.py')
checkpoint_file = osp.join(WEIGHT_DIR, 'iter_15000.pth')
...
for i in range(0, length, 1):
    ...
    mask_path = img_path.replace('images_patch_1030', 'masks_patch_1030')
