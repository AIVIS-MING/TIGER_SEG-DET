...
from .uper_uhead import UPer_UHead
from .uper_uhead_v2 import UPer_UHead_V2

__all__ = [
    'FCNHead', 'PSPHead', 'ASPPHead', 'PSAHead', 'NLHead', 'GCHead', 'CCHead',
    'UPerHead', 'UPer_UHead', 'UPer_UHead_V2','DepthwiseSeparableASPPHead', 'ANNHead', 'DAHead', 'OCRHead',
