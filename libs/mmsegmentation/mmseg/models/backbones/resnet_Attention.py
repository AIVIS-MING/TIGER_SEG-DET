...
from ..utils import ResLayer, BAM, CBAM
...
class Bottleneck(BaseModule):
    ...
    def __init__(self,
        ...
        if use_cbam:
            self.cbam = CBAM(planes*4, 16, pool_types=pool_types, no_spatial=no_spatial)
        else:
            self.cbam = None
...
class ResNet_Attention(BaseModule):
    """ResNet backbone.
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(ResNet_Attention, self).__init__(init_cfg)
    ...
    def train(self, mode=True):
        ...
        freezed."""
        super(ResNet_Attention, self).train(mode)
        self._freeze_stages()
...
@BACKBONES.register_module()
class ResNetV1c_Attention(ResNet_Attention):
    ...
    def __init__(self, **kwargs):
        super(ResNetV1c_Attention, self).__init__(
            deep_stem=True, avg_down=False, **kwargs)


@BACKBONES.register_module()
class ResNetV1d_Attention(ResNet_Attention):
    ...
    def __init__(self, **kwargs):
        super(ResNetV1d_Attention, self).__init__(
